                                                ...
                                                <?php while($usuario = mysqli_fetch_assoc($usuarios)){?>
                                                        <tr class="gradeA odd">
                                                                ...
                                                                <td style="width:40%" class="center">
                                                                    ...
                                                                    <a  onClick="if(confirm('Tem certeza que deseja excluir este registro?')){location.href='excluir.php?id_usuario=<?php echo $usuario['id_usuario']; ?>'}" class="btn btn-danger"> <i class="icon-trash">&nbsp;&nbsp;Excluir</i> </a>
