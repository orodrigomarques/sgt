...
function meu_callback(conteudo) {
  if (!("erro" in conteudo)) {
    ...
    document.getElementById('nm_local').value = (conteudo.logradouro);
    document.getElementById('nm_bairro').value = (conteudo.bairro);
    document.getElementById('nm_municipio').value = (conteudo.localidade);
    document.getElementById('nm_UF').value = (conteudo.uf);
