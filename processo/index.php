...
<?php if (mysqli_num_rows($processos) > 0) { ?>
    ...
    <?php while ($processo = mysqli_fetch_assoc($processos)) { ?>
                                                            ...
                                                            </tr><?php $cd_proceso = $processo['cd_processo']; 
                                                            $sql_recursos = "SELECT * FROM recurso where cd_processo = $cd_proceso "; 
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                      ...
                                                                      <?php if($recursos->num_rows == 0) {echo 'Não há recursos para esse processo';}?>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <p>Resultado do recurso: <?php if($recurso['ds_resultado_recurso'] == ''){echo 'Sem resultado';}else{echo $recurso['ds_resultado_recurso']; }?></p>
                                                                        <?php } ?>   </div> 
                                                                </div>
                                                            </div>
                                                        </div> 
